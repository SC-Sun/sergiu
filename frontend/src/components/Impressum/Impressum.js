  ...
  return (
    <div className="impressum-container">
      ...
      <p>
        ...
        Vorname: Sergiu, Name: Matis,
        <br />
        Adresse: xxxxxx PLZ: xxxx
        <br />
        Gestaltung und Umsetzung: Sunc & Rohn Inhalt: Sergiu Matis, Philip Matis
        Fotos: Philip Matis
      </p>
      <p>
        Umsatzsteuer-ID Umsatzsteuer-Identifikationsnummer: xxxxxx
        <br />
        gem. § 27 a Umsatzsteuergesetz: DE XXX XXX XXX
        ...
        <br />
        <br /> Urheberrecht
        <br /> Die auf unserer Webseite veröffentlichen Inhalte und Werke
